  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
      		<a class="nav-link active" href="/VTC">VTC</a> 
        </li> 
        <li class="nav-item">
          <a class="nav-link active" href="conducteur">Conducteur</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="vehicule">Véhicule</a>
        </li> 
        <li class="nav-item">
          <a class="nav-link active" href="association">Association</a>
      </ul>
